    ...
    <div className="form">
      <div className="form-body">
        ...
        <div className="phoneno">
          ...
          <input type="number" value={phoneno} onChange={(e) => setPhoneno(e.target.value)} id="phoneno" className="form__input" placeholder="Phoneno" />
        </div>
        ...
        <div className="confirm-password">
          ...
          <input className="form__input" type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} id="confirmPassword" placeholder="Confirm Password" />
        </div>
      </div>
      <div class="footer">
